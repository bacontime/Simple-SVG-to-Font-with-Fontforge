...
INPUTFOLDER = 'svg'
OUTPUTFILENAME = 'OUTPUTFONTFILENAME.ttf'
PLACEHOLDERGEOMETRYSVG = 'svg/25A1.svg'

font = fontforge.font()
font.familyname = "FONTFAMILYNAME"
font.fullname = font.familyname + " Black Regular"
font.copyright = "COPYRIGHT MESSAGE HERE" #eg Copyright (c) 2022 Name
font.version = "1.0 or something like that."
